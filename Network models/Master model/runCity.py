...
layers, attrs, cliques = initModel('idAndAge_'+city+'.txt', 'socialNetwork_'+city+'.txt', '', baseP, [10, 3, -0.75], 200)
#genBlankState(attrs)
#seedState(attrs, 20)
...
#stateLog, infLog, infLogByLayer, i = timedRun(attrs, layers, cliques, strat, baseP, 0, 40)
#processed_list = Parallel(n_jobs=ncores)(delayed(timedRun)(attrs, layers, cliques, strat, baseP, 0, 40) for i in range(40))
